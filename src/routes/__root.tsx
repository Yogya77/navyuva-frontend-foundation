    ...
    head: () => ({
      meta: [
        ...
        },
        {
          name: "description",
          content:
            "NAVYUVA is an interactive platform for exploring civilization, history, and culture through games, artifact discovery, and virtual museums.",
        },
        { name: "author", content: "NAVYUVA" },
        { property: "og:title", content: "NAVYUVA — Heritage & Culture" },
        {
          property: "og:description",
          content:
            "Discover the past and play the story with NAVYUVA.",
        },
        { property: "og:type", content: "website" },
        { name: "twitter:card", content: "summary_large_image" },
        { name: "twitter:site", content: "@Navyuva" },
      ],
      links: [
        {
          rel: "stylesheet",
